 ...
 * 
 * Licensed under the GPL or commercial licenses To use it on other terms please contact us: info@jeasyui.com http://www.gnu.org/licenses/gpl.txt
 ...
 * 修改内容：
 * 		
 * 		1、当光标离开时自动去掉输入框内容前后的空格；
 * 		2、如果组件内容为空，那么在光标离开时不进行验证，只有内容不为空光标离开才会验证。但是表单在提交时不管内容是否为空都会进行验证。
 */
(function($)
{
	$.parser = {
		...
		plugins : [
				"draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "combobox", "combotree", "combogrid",
				"numberbox", "validatebox", "searchbox", "numberspinner", "timespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid",
...
(function($)
{
	...
	{
		var t = $(_7f);
		return $.extend({}, $.parser.parseOptions(_7f, [
				"id", "iconCls", "iconAlign", "group", {
					plain : "boolean",
					toggle : "boolean",
					selected : "boolean"
				}
...
(function($)
{
	...
	{
		var t = $(_192);
		return $.extend({}, $.parser.parseOptions(_192, [
				"url", "method", {
					checkbox : "boolean",
...
(function($)
{
	...
	function _1c7(_1c8, e)
	{
		...
		{
			tip = $(
					"<div tabindex=\"-1\" class=\"tooltip\">" + "<div class=\"tooltip-content\"></div>" + "<div class=\"tooltip-arrow-outer\"></div>" + "<div class=\"tooltip-arrow\"></div>"
							+ "</div>").appendTo("body");
			_1c9.tip = tip;
			_1ca(_1c8);
		}
	...
	{
		var t = $(_1da);
		var opts = $.extend({}, $.parser.parseOptions(_1da, [
...
(function($)
{
	...
	{
		var t = $(_228);
		return $.extend({}, $.parser.parseOptions(_228, [
...
(function($)
{
	...
	{
		return $.extend({}, $.fn.window.parseOptions(_26a), $.parser.parseOptions(_26a, [
				"toolbar", "buttons"
		]));
	};
...
(function($)
{
	...
	$.messager = {
		...
		{
			var _27e = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>"
...
(function($)
{
	...
	{
		var t = $(_2cf);
		return $.extend({}, $.parser.parseOptions(_2cf, [
				"width", "height", {
					fit : "boolean",
					border : "boolean",
					animate : "boolean",
...
(function($)
{
	...
	{
		return $.extend({}, $.parser.parseOptions(_344, [
...
(function($)
{
	...
	{
		var t = $(_396);
		return $.extend({}, $.fn.panel.parseOptions(_396), $.parser.parseOptions(_396, [
				"region", {
					split : "boolean",
					minWidth : "number",
					minHeight : "number",
...
(function($)
{
	function init(_397)
	{
		...
		function _39b(menu)
		{
			var _39e = $.parser.parseOptions(menu[0], [
				"width"
			]).width;
			if (menu.hasClass("menu-content"))
			{
	...
	{
		return $.extend({}, $.parser.parseOptions(_3d0, [
				"left", "top", {
					minWidth : "number",
...
(function($)
{
	...
	{
		var t = $(_3e3);
		return $.extend({}, $.fn.linkbutton.parseOptions(_3e3), $.parser.parseOptions(_3e3, [
				"menu", {
					plain : "boolean",
					duration : "number"
				}
...
(function($)
{
	...
	{
		var t = $(_3eb);
		return $.extend({}, $.fn.linkbutton.parseOptions(_3eb), $.parser.parseOptions(_3eb, [
				"menu", {
					plain : "boolean",
					duration : "number"
				}
...
(function($)
{
	...
	{
		var t = $(_407);
		return $.extend({}, $.parser.parseOptions(_407, [
...
(function($)
{
			...
			(function()
			{
				if (_40f.validating)
				{
					if (_40f.value != box.val())
					{
						...
						/*
						 * _40f.timer=setTimeout(function(){ $(_40e).validatebox("validate"); },_40f.options.delay);
						 */
					}
					else
					{
	...
	{
		var t = $(_429);
		return $.extend({}, $.parser.parseOptions(_429, [
...
(function($)
{
	...
	function _443(_444)
	{
		...
		var t = $(_444);
		var _445 = [
				"combo", "combobox", "combotree", "combogrid", "slider"
		];
	...
	function _448(_449)
	{
		...
		var t = $(_449);
		var _44a = [
				"combo", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "spinner", "timespinner", "numberbox", "numberspinner", "slider"
		];
...
(function($)
{
	...
	{
		var t = $(_470);
		return $.extend({}, $.fn.validatebox.parseOptions(_470), $.parser.parseOptions(_470, [
...
(function($)
{
	...
	{
		var t = $(_499);
		return $.extend({}, $.parser.parseOptions(_499, [
				"width", "height", {
					firstDay : "number",
					fit : "boolean",
					border : "boolean"
...
(function($)
{
	function init(_49a)
	{
		var _49b = $("<span class=\"spinner\">" + "<span class=\"spinner-arrow\">" + "<span class=\"spinner-arrow-up\"></span>" + "<span class=\"spinner-arrow-down\"></span>" + "</span>" + "</span>")
				.insertAfter(_49a);
	...
	{
		var t = $(_4af);
		return $.extend({}, $.fn.validatebox.parseOptions(_4af), $.parser.parseOptions(_4af, [
...
(function($)
{
	...
	function _4be(_4c6)
	{
		...
		var tt = [
				_4ca(time.getHours()), _4ca(time.getMinutes())
		];
		if (opts.showSeconds)
		{
	...
	{
		return $.extend({}, $.fn.spinner.parseOptions(_4d3), $.parser.parseOptions(_4d3, [
				"separator", {
					showSeconds : "boolean",
					highlight : "number"
				}
...
(function($)
{
	...
	function _50b(_50c, _50d)
	{
		...
		var _511 = $(
				"<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">" + "<div class=\"datagrid-header\">"
						...
						+ "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_50c);
		_511.panel({
			doSize : false
		});
	...
	{
		var t = $(_685);
		return $.extend({}, $.fn.panel.parseOptions(_685), $.parser.parseOptions(_685, [
					...
					$.fn.datagrid.defaults.view,
					{
						...
						onBeforeRender : function(_712, rows)
						{
							...
							function _714()
							{
								...
								{
									$("head")
											.append("<style id=\"datagrid-group-style\">" + ".datagrid-group{height:25px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;}" + "</style>");
								}
							}
							;
						}
...
(function($)
{
	...
	{
		return $.extend({}, $.fn.datagrid.parseOptions(_7af), $.parser.parseOptions(_7af, [
				"treeField", {
					animate : "boolean"
				}
		]));
...
(function($)
{
	...
	function init(_7fb)
	{
		...
		var span = $(
				"<span class=\"combo\">" + "<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">" + "<span><span class=\"combo-arrow\"></span></span>"
						+ "<input type=\"hidden\" class=\"combo-value\">" + "</span>").insertAfter(_7fb);
	...
	{
		var t = $(_84b);
		return $.extend({}, $.fn.validatebox.parseOptions(_84b), $.parser.parseOptions(_84b, [
...
(function($)
{
	...
	{
		var t = $(_88e);
		return $.extend({}, $.fn.combo.parseOptions(_88e), $.parser.parseOptions(_88e, [
...
(function($)
{
	...
	{
		var t = $(_8d4);
		return $.extend({}, $.fn.combo.parseOptions(_8d4), $.fn.datagrid.parseOptions(_8d4), $.parser.parseOptions(_8d4, [
...
(function($)
{
	...
	{
		return $.extend({}, $.fn.combo.parseOptions(_8ee), $.parser.parseOptions(_8ee, [
			"sharedCalendar"
		]));
	};
...
(function($)
{
	...
	function _8f8(_8ff, _900, _901)
	{
		...
		function _902(date)
		{
			...
			;
			var tt = [
					_903(date.getHours()), _903(date.getMinutes())
			];
			if (opts.showSeconds)
			{
	...
	{
		var t = $(_90b);
		return $.extend({}, $.fn.datebox.parseOptions(_90b), $.parser.parseOptions(_90b, [
				"timeSeparator", {
					showSeconds : "boolean"
				}
		]));
...
(function($)
{
	...
	{
		var t = $(_948);
		return $.extend({}, $.parser.parseOptions(_948, [
				"width", "height", "mode", {
					reversed : "boolean",
					showTip : "boolean",
					min : "number",
...
(function($)
{
	...
	function _6(_7)
	{
			...
			(function()
			{
				if (_9.validating)
				{
					if (_9.value != _8.val())
					{
						...
						/*
						 * _9.timer=setTimeout(function(){ $(_7).validatebox("validate"); },_9.options.delay);
						 */
		...
		}).bind("blur.validatebox", function()
		{
			...
			//强当安修改 光标离开时自动去掉空格
			$(_7).val($(_7).val().trim());
            //强当安修改，当光标离开时，如果组件为空就不验证，只有不为空才验证
			if($(_7).val().trim()!="")
            {
